...
const open_fullscreen = {
    ...
    message: [
        language.fullscreen.fullscreenText,
         '<strong>若您同意参与且准备好了，请点击继续：</strong> '
    ],
...
const instructions = {
    type: "instructions",
    pages: [
        `<h1>${language.welcomePage.welcome}</h1><br><p class="center">${language.welcomePage.clickNext}</p>`,
        `<p class="center">${language.instruction.fourCards}</p><p class="center">${language.instruction.newCard}</p><p class="center">${language.instruction.clickCard}</p><br><img src="../static/images/instruction.png" style="width: 500px"/></p><p style="color: #f6f6f8">Placeholder</p>`,
        `<p class="center">${language.instruction.rule}</p><p class="center">${language.instruction2.ruleChange}</p><p class="center">${language.instruction2.ruleChange2}</p><br><img src="../static/images/instruction.png" style="width: 500px"/><p class="center">${language.instruction2.clickNext}</p>`,
    ],
...
const endTask = {
    ...
    stimulus: function() {
        return `<h1>${language.end.end}</h1><br><h1>${language.end.thankYou}</h1><br><h1>${language.end.data}</h1>`
        },
    trial_duration: 8000,
    data: {test_part: "end"},
...
timeline.push(open_fullscreen, instructions)
